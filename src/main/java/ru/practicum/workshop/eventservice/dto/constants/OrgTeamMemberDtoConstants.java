...
public class OrgTeamMemberDtoConstants {
    ...
    public static final String USER_ID_NOT_NULL_ERROR_MESSAGE = "User id must be provided.";
    public static final String USER_ID_POSITIVE_ERROR_MESSAGE = "User id must be positive.";

    public static final String ROLE_NOT_NULL_ERROR_MESSAGE = "Member role must be provided.";
